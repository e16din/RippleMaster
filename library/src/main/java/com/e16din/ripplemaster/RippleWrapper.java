...
public class RippleWrapper {
    ...
    public RippleWrapper(@NonNull View view, @Nullable Drawable rippleDrawable) {
        this(view, rippleDrawable, false);
    }

    public RippleWrapper(@NonNull View view, @Nullable Drawable rippleDrawable, boolean foreground) {
